      ...
      <div className="container mx-auto px-4 py-16">
        ...
        >
          <p>
            ...
            ("User," "you," or "your"), and Praevion ("Company," "we," "us," or "our"). These Terms govern your access
          ...
          <p>
            Praevion provides a suite of advanced artificial intelligence-powered automation and development services,
          ...
          <p>
            ...
            developed, created, or provided by Praevion, including but not limited to our proprietary artificial
            intelligence agents, machine learning models, automated workflows, and any derivative works thereof, shall
            remain the exclusive property of Praevion, unless explicitly stated otherwise in a separate, written
            ...
            Praevion. Any artificial intelligence-generated content, insights, or outputs provided through our Services
            ...
            feedback, suggestions, or ideas provided to Praevion regarding the Services may be used by Praevion without
          ...
          <p>
            ...
            User. Unless otherwise specified in writing, Praevion does not offer refunds for completed work or services
            rendered. In the event of a dispute regarding payments or service delivery, the User agrees to engage in
            good faith negotiations with Praevion to resolve such disputes before pursuing any legal remedies.
          </p>

          <h2 className="text-2xl font-semibold mt-8 mb-4">6. Limitation of Liability and Indemnification</h2>
          <p>
            Praevion shall not be liable for any indirect, incidental, special, consequential, or punitive damages
            resulting from the User's use of our Services, including but not limited to loss of profits, data, or
            business opportunities. The User agrees that Praevion's total liability in connection with these Terms or
            the use of the Services shall not exceed the amount paid by the User for the specific service in question.
            The User agrees to indemnify, defend, and hold harmless Praevion, its officers, directors, employees,
          ...
          <p>
            ...
            respective terms and conditions, privacy policies, and data processing practices. Praevion expressly
            ...
            before utilizing them in conjunction with Praevion's Services.
          </p>

          <h2 className="text-2xl font-semibold mt-8 mb-4">8. Hosting, Deployment, and Data Processing</h2>
          <p>
            Praevion utilizes Vercel for hosting and deploying our website and certain components of our Services. By
            ...
            Praevion and its third-party service providers all necessary rights and licenses to process, store, and
          ...
          <p>
            Praevion reserves the right, in its sole discretion, to terminate or suspend access to the Services
          ...
          <p>
            Praevion reserves the right, at its sole discretion, to modify or replace these Terms of Service at any
          ...
          <p className="mt-2">Electronic mail: legal@praevion.com</p>
